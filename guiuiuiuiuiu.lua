...
do
    ...
    function utility:isAlphabetic(Character)
        return type(Character) == "string" and Character:len() == 1 and Character:match("[a-zA-Z]") ~= nil
    end

    -- // function i will never use?

    function utility:ShiftKey(key)
        if utility:isAlphabetic(key) then
            return key:upper()
        else
...
function library.New(self, info, theme)
    ...
    function window.Tab(self, info)
        ...
        function tab.Section(self, info)
            ...
            function section._Keybind(self, info, offsets, parent, do_update, pointer, name2)
                ...
                local showinkeybindlist = info.keybindlist or false

                local keybind = {keybindlist = showinkeybindlist, value = def, flag = flag, pointer = pointer, name = name, sname = name2, mode = "toggle", instances = {}, minst = {}, binding = false, enabled = false, callback = callback}
                ...
                utility:Image(keybind_gradient, "https://i.imgur.com/yjsYzc7.png")

                function keybind.Get(self)
                    return {self.value, self.mode, self.enabled}
                end
                ...
                utility:Connect(uis.InputBegan, function (input, gameprocessing)
                    if gameprocessing then return end
                    if input.KeyCode.Name == keybind.value or input.UserInputType.Name == keybind.value then
                        if keybind.mode == 'toggle' then
                            keybind.enabled = not keybind.enabled
                        elseif keybind.mode == 'hold' then
                            keybind.enabled = true
    
                            local c; c = utility:Connect(uis.InputEnded, function(input)
                                if input.KeyCode.Name == keybind.value or input.UserInputType.Name == keybind.value then
                                    c:Disconnect()
                                    keybind.enabled = false
                                    keybind.callback(keybind.enabled)
                                end
                            end)
                        else
                            keybind.enabled = true
    
                            local c; c = utility:Connect(rs.Heartbeat, function(delta)
                                if (input.KeyCode.Name == keybind.value and not uis:IsKeyDown(Enum.KeyCode[keybind.value])) or (input.UserInputType.Name == keybind.value and not uis:IsMouseButtonPressed(Enum.UserInputType[keybind.value])) then
                                    c:Disconnect()
                                    keybind.enabled = false
                                    keybind.callback(keybind.enabled)
                                end
            ...
            function section._Colorpicker(self, info, offsets, parent, do_update, pointer, cptable)
                ...
                utility:Image(cpframe_gradient, "https://i.imgur.com/yjsYzc7.png")
                ...
                function colorpicker.Open(self)
                    ...
                    utility:Image(cpdropframe_color_image, "https://i.imgur.com/WUK9bmv.png")
                    utility:Image(cpdropframe_hue_image, "https://i.imgur.com/FwQT0Us.png")
                    utility:Image(cpdropframe_trans_image, "https://i.imgur.com/99R9ku7.png")
            ...
            function section.Button(self, info)
                ...
                utility:Image(button_gradient, "https://i.imgur.com/yjsYzc7.png")
            ...
            function section.Textbox(self, info)
                ...
                local callback = info.callback or function() end
                local focuslostcallback = info.focuslost or function() end
                local flag = info.flag
                ...
                utility:Image(textbox_gradient, "https://i.imgur.com/yjsYzc7.png")
            ...
            function section.Toggle(self, info)
                ...
                utility:Image(toggle_gradient, "https://i.imgur.com/yjsYzc7.png")
            ...
            function section.Slider(self, info)
                ...
                utility:Image(slider_gradient, "https://i.imgur.com/yjsYzc7.png")
            ...
            function section.Dropdown(self, info)
                ...
                utility:Image(dropdown_gradient, "https://i.imgur.com/yjsYzc7.png")
                utility:Image(dropdown_image, "https://i.imgur.com/6sUe3ze.png")
                ...
                function dropdown.Open(self)
                    ...
                    utility:Image(dropdown_image, "https://i.imgur.com/bmCrOaB.png")
    ...
    function window.Notifications(self)
        ...
        function notiflist.new(self, info)
            ...
            local show_dur_bar = info.show_dur_bar
    ...
    function window.Watermark(self)
        ...
        utility:Image(watermark_gradient, "https://i.imgur.com/yjsYzc7.png")
    ...
    function window.Tooltip(self)
        ...
        function tooltip.SetText(self, text)
            ...
            tt_frame.Size = v2new(13 + utility:GetPlexSize(text), 4 + (#text:split("\n")*13))
